        ...
        public async Task<AiExecutionResult> ExecuteAsync(AiCommand command) {
            ...
            try {
                switch (command.Action.ToLowerInvariant()) {
                    case "help":
                        result = Ok("Supported: connect, status, start_sequence, stop, park, unpark, platesolve, center, slew. JSON example: {\"action\":\"slew\",\"parameters\":{\"ra\":\"5.5\",\"dec\":\"-2.1\",\"ra_unit\":\"hours\"}}");
                        break;
